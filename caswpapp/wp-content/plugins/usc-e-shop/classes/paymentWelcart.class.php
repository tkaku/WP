...
class WELCARTPAY_SETTLEMENT extends ESCOTT_MAIN
{
	...
	public function initialize_data() {
		...
		//if( !isset( $options['acting_settings'] ) || !isset( $options['acting_settings']['welcart'] ) ) {
		...
		$this->unavailable_method = array( 'acting_escott_card', 'acting_zeus_card', 'acting_zeus_conv', 'acting_sbps_card' );
	}
...
jQuery( document ).ready( function( $ ) {
	...
	var applepay_activate = "<?php echo $acting_opts['applepay_activate']; ?>";
	var unionpay_activate = "<?php echo $acting_opts['unionpay_activate']; ?>";
	...
	if( "on" == card_activate || "token" == card_activate ) {
		...
		var quickpay_welcart = "<?php echo $acting_opts['quickpay']; ?>";
	...
	$( document ).on( "change", "#fee_limit_amount_change", function() {
		if( "change" == $( "input[name='fee_type']:checked" ).val() ) {
			...
			if( amount >= limit ) {
				alert( "<?php _e( 'A value of the amount of upper limit is incorrect.', 'usces' ); ?>"+amount+' : '+limit );
			}
		}
	});
...
jQuery( document ).ready( function( $ ) {
	adminOrderEdit = {
		...
		addSettlementConv : function( paylimit, amount ) {
			...
			<?php elseif( 'acting_welcart_unionpay' == $acting_flg ): ?>
		...
		update : function() {
			$.ajax({
				...
				if( retVal.status == "OK" ) {
					...
					mes = ( retVal.message != "" ) ? retVal.message : "<?php _e( 'failure in update', 'usces' ); ?>";
...
<?php
	...
	public function settlement_update() {
		...
		$options['acting_settings']['welcart']['merchant_id'] = ( isset( $_POST['merchant_id'] ) ) ? trim( $_POST['merchant_id'] ) : '';
		$options['acting_settings']['welcart']['merchant_pass'] = ( isset( $_POST['merchant_pass'] ) ) ? trim( $_POST['merchant_pass'] ) : '';
		$options['acting_settings']['welcart']['tenant_id'] = ( isset( $_POST['tenant_id'] ) ) ? trim( $_POST['tenant_id'] ) : '0001';
		$options['acting_settings']['welcart']['auth_key'] = ( isset( $_POST['auth_key'] ) ) ? trim( $_POST['auth_key'] ) : '';
		$options['acting_settings']['welcart']['ope'] = ( isset( $_POST['ope'] ) ) ? $_POST['ope'] : '';
		$options['acting_settings']['welcart']['card_activate'] = ( isset( $_POST['card_activate'] ) ) ? $_POST['card_activate'] : 'off';
		...
		$options['acting_settings']['welcart']['sec3d_activate'] = ( isset( $_POST['sec3d_activate'] ) ) ? $_POST['sec3d_activate'] : 'off';
		$options['acting_settings']['welcart']['token_code'] = ( isset( $_POST['token_code'] ) ) ? trim( $_POST['token_code'] ) : '';
		$options['acting_settings']['welcart']['quickpay'] = ( isset( $_POST['quickpay'] ) ) ? $_POST['quickpay'] : '';
		$options['acting_settings']['welcart']['chooseable_quickpay'] = ( isset( $_POST['chooseable_quickpay'] ) ) ? $_POST['chooseable_quickpay'] : 'on';
		$options['acting_settings']['welcart']['operateid'] = ( isset( $_POST['operateid'] ) ) ? $_POST['operateid'] : '1Gathering';
		$options['acting_settings']['welcart']['operateid_dlseller'] = ( isset( $_POST['operateid_dlseller'] ) ) ? $_POST['operateid_dlseller'] : '1Gathering';
		$options['acting_settings']['welcart']['auto_settlement_mail'] = ( isset( $_POST['auto_settlement_mail'] ) ) ? $_POST['auto_settlement_mail'] : 'off';
		$options['acting_settings']['welcart']['howtopay'] = ( isset( $_POST['howtopay'] ) ) ? $_POST['howtopay'] : '';
		$options['acting_settings']['welcart']['conv_activate'] = ( isset( $_POST['conv_activate'] ) ) ? $_POST['conv_activate'] : 'off';
		...
		$options['acting_settings']['welcart']['conv_fee_limit_amount'] = ( isset( $_POST['conv_fee_limit_amount_'.$options['acting_settings']['welcart']['conv_fee_type']] ) ) ? $_POST['conv_fee_limit_amount_'.$options['acting_settings']['welcart']['conv_fee_type']] : '';
		...
		$options['acting_settings']['welcart']['atodene_activate'] = ( isset( $_POST['atodene_activate'] ) ) ? $_POST['atodene_activate'] : 'off';
		...
		$options['acting_settings']['welcart']['atodene_fee_limit_amount'] = ( isset( $_POST['atodene_fee_limit_amount_'.$options['acting_settings']['welcart']['atodene_fee_type']] ) ) ? $_POST['atodene_fee_limit_amount_'.$options['acting_settings']['welcart']['atodene_fee_type']] : '';
		...
		$options['acting_settings']['welcart']['applepay_activate'] = ( isset( $_POST['applepay_activate'] ) ) ? $_POST['applepay_activate'] : 'off';
		$options['acting_settings']['welcart']['applepay_tenant_id'] = ( isset( $_POST['applepay_tenant_id'] ) ) ? $_POST['applepay_tenant_id'] : '';
		$options['acting_settings']['welcart']['applepay_quickpay'] = ( isset( $_POST['applepay_quickpay'] ) ) ? $_POST['applepay_quickpay'] : '';
		$options['acting_settings']['welcart']['applepay_operateid'] = ( isset( $_POST['applepay_operateid'] ) ) ? $_POST['applepay_operateid'] : '1Gathering';
		$options['acting_settings']['welcart']['applepay_key_aes'] = ( isset( $_POST['applepay_key_aes'] ) ) ? $_POST['applepay_key_aes'] : '';
		$options['acting_settings']['welcart']['applepay_key_iv'] = ( isset( $_POST['applepay_key_iv'] ) ) ? $_POST['applepay_key_iv'] : '';
		$options['acting_settings']['welcart']['applepay_certificate_path'] = ( isset( $_POST['applepay_certificate_path'] ) ) ? $_POST['applepay_certificate_path'] : '';
		$options['acting_settings']['welcart']['applepay_certificate_key_pass'] = ( isset( $_POST['applepay_certificate_key_pass'] ) ) ? $_POST['applepay_certificate_key_pass'] : '';
		$options['acting_settings']['welcart']['applepay_merchantidentifier'] = ( isset( $_POST['applepay_merchantidentifier'] ) ) ? $_POST['applepay_merchantidentifier'] : '';
		$options['acting_settings']['welcart']['unionpay_activate'] = ( isset( $_POST['unionpay_activate'] ) ) ? $_POST['unionpay_activate'] : 'off';
		$options['acting_settings']['welcart']['unionpay_key_aes'] = ( isset( $_POST['unionpay_key_aes'] ) ) ? $_POST['unionpay_key_aes'] : '';
		$options['acting_settings']['welcart']['unionpay_key_iv'] = ( isset( $_POST['unionpay_key_iv'] ) ) ? $_POST['unionpay_key_iv'] : '';
		$options['acting_settings']['welcart']['unionpay_pagelanguage'] = ( isset( $_POST['unionpay_pagelanguage'] ) ) ? $_POST['unionpay_pagelanguage'] : '';
		...
		if( 'on' == $options['acting_settings']['welcart']['unionpay_activate'] ) {
			if( WCUtils::is_blank( $_POST['unionpay_key_aes'] ) ) {
				$this->error_mes .= __( '* Please enter the UnionPay tripartite encryption key.', 'usces' ).'<br />';
			}
			if( WCUtils::is_blank( $_POST['unionpay_key_iv'] ) ) {
...
?>
	...
	<form action="" method="post" name="welcart_form" id="welcart_form">
		<table class="settle_table">
			<tr>
				<th><a class="explanation-label" id="label_ex_merchant_id_welcart"><?php _e( 'Merchant ID', 'usces' );//マーチャントID ?></a></th>
				<td><input name="merchant_id" type="text" id="merchant_id_welcart" value="<?php echo $acting_opts['merchant_id']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_merchant_id_welcart" class="explanation"><td colspan="2"><?php _e( 'Merchant ID (single-byte numbers only) issued from e-SCOTT.', 'usces' ); ?></td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_merchant_pass_welcart"><?php _e( 'Merchant Password', 'usces' );//マーチャントパスワード ?></a></th>
				<td><input name="merchant_pass" type="text" id="merchant_pass_welcart" value="<?php echo $acting_opts['merchant_pass']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_merchant_pass_welcart" class="explanation"><td colspan="2"><?php _e( 'Merchant Password (single-byte alphanumeric characters only) issued from e-SCOTT.', 'usces' ); ?></td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_tenant_id_welcart"><?php _e( 'Tenant ID', 'usces' );//店舗コード ?></a></th>
				<td><input name="tenant_id" type="text" id="tenant_id_welcart" value="<?php echo $acting_opts['tenant_id']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_tenant_id_welcart" class="explanation"><td colspan="2"><?php _e( 'Tenant ID issued from e-SCOTT.<br />If you have only one shop to contract, enter 0001.', 'usces' ); ?></td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_auth_key_welcart"><?php _e( 'Settlement auth key', 'usces' );//決済認証キー ?></a></th>
				<td><input name="auth_key" type="text" id="auth_key_welcart" value="<?php echo $acting_opts['auth_key']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_auth_key_welcart" class="explanation"><td colspan="2"><?php _e( 'Settlement auth key (single-byte numbers only) issued from e-SCOTT.', 'usces' ); ?></td></tr>
			<tr>
				<th><a class="explanation-label" id="label_ex_ope_welcart"><?php _e( 'Operation Environment', 'usces' );//動作環境 ?></a></th>
				<td><label><input name="ope" type="radio" id="ope_welcart_1" value="test"<?php if( $acting_opts['ope'] == 'test' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Testing environment', 'usces' ); ?></span></label><br />
					<label><input name="ope" type="radio" id="ope_welcart_2" value="public"<?php if( $acting_opts['ope'] == 'public' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Production environment', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_ope_welcart" class="explanation"><td colspan="2"><?php _e( 'Switch the operating environment.', 'usces' ); ?></td></tr>
		</table>
		<table class="settle_table">
			<tr>
				<th><?php _e( 'Credit card settlement', 'usces' );//クレジットカード決済 ?></th>
				<td><label><input name="card_activate" type="radio" class="card_activate_welcart" id="card_activate_welcart_1" value="on"<?php if( $acting_opts['card_activate'] == 'on' || $acting_opts['card_activate'] == 'token' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use with non-passage type', 'usces' ); ?></span></label><br />
					<label><input name="card_activate" type="radio" class="card_activate_welcart" id="card_activate_welcart_2" value="link"<?php if( $acting_opts['card_activate'] == 'link' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use with external link type', 'usces' ); ?></span></label><br />
				<!--<label><input name="card_activate" type="radio" class="card_activate_welcart" id="card_activate_welcart_3" value="token"<?php if( $acting_opts['card_activate'] == 'token' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use with token type', 'usces' ); ?></span></label><br />-->
					<label><input name="card_activate" type="radio" class="card_activate_welcart" id="card_activate_welcart_0" value="off"<?php if( $acting_opts['card_activate'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<!--<tr class="card_welcart">
				<th><a class="explanation-label" id="label_ex_foreign_activate_welcart"><?php _e( 'Foreign exchange settlement', 'usces' );//外貨決済 ?></a></th>
				<td><label><input name="foreign_activate" type="radio" id="foreign_activate_welcart_1" value="on"<?php //if( $acting_opts['foreign_activate'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="foreign_activate" type="radio" id="foreign_activate_welcart_2" value="off"<?php //if( $acting_opts['foreign_activate'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_foreign_activate_welcart" class="explanation card_welcart"><td colspan="2"><?php _e( 'Foreign exchange settlement, only two VISA and MasterCard card companies are available.<br />If switching to Yen card is done during operation, the member information registered in e-SCOTT will be invalid.', 'usces' ); ?></td></tr>-->
			<tr class="card_sec3d_welcart">
				<th><a class="explanation-label" id="label_ex_sec3d_activate"><?php _e( '3D Secure', 'usces' );//3Dセキュア ?></a></th>
				<td><label><input name="sec3d_activate" type="radio" class="sec3d_activate_welcart" id="sec3d_activate_1" value="on"<?php if( $acting_opts['sec3d_activate'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="sec3d_activate" type="radio" class="sec3d_activate_welcart" id="sec3d_activate_0" value="off"<?php if( $acting_opts['sec3d_activate'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_sec3d_activate" class="explanation card_welcart"><td colspan="2"><?php _e( "3D secure authentication at the time of payment. If you want to use it, you need to apply to Sony Payment Service Co., Ltd.", 'usces' ); ?></td></tr>
			<tr class="card_token_code_welcart">
				<th><a class="explanation-label" id="label_ex_token_code_welcart"><?php _e( 'Token auth code', 'usces' );//トークン決済認証コード ?></a></th>
				<td><input name="token_code" type="text" id="token_code_welcart" value="<?php echo $acting_opts['token_code']; ?>" class="regular-text" maxlength="32" /></td>
			</tr>
			<tr id="ex_token_code_welcart" class="explanation card_token_code_welcart"><td colspan="2"><?php _e( "Token auth code (single-byte alphanumeric characters only) issued from e-SCOTT.", 'usces' ); ?></td></tr>
			<tr class="card_welcart">
				<th><a class="explanation-label" id="label_ex_seccd_welcart"><?php _e( 'Security code <br /> (authentication assist)', 'usces' );//セキュリティコード ?></a></th>
				<td><label><input name="seccd" type="radio" id="seccd_welcart_1" value="on"<?php if( $acting_opts['seccd'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="seccd" type="radio" id="seccd_welcart_0" value="off"<?php if( $acting_opts['seccd'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_seccd_welcart" class="explanation card_welcart"><td colspan="2"><?php _e( "Use 'Security code' of authentication assist matching. If you decide not to use, please also set 'Do not verify matching' on the e-SCOTT management screen.", 'usces' ); ?></td></tr>
			<tr class="card_welcart">
				<th><a class="explanation-label" id="label_ex_quickpay_welcart"><?php _e( 'Quick payment', 'usces' );//クイック決済 ?></a></th>
				<td><label><input name="quickpay" type="radio" class="quickpay_welcart" id="quickpay_welcart_1" value="on"<?php if( $acting_opts['quickpay'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="quickpay" type="radio" class="quickpay_welcart" id="quickpay_welcart_0" value="off"<?php if( $acting_opts['quickpay'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_quickpay_welcart" class="explanation card_welcart"><td colspan="2"><?php _e( "Members can pay with saved card. Card number will be registered in e-SCOTT Smart system.", 'usces' ); ?><?php _e( "When using automatic continuing charging (required WCEX DLSeller) or subscription (required WCEX Auto Delivery), please make 'Quick payment' of 'Use'.", 'usces' ); ?></td></tr>
			<tr class="card_chooseable_quickpay_welcart">
				<th><a class="explanation-label" id="label_ex_chooseable_quickpay_welcart"><?php _e( 'Register credit card', 'usces' );//クレジットカードの登録 ?></a></th>
				<td><label><input name="chooseable_quickpay" type="radio" class="chooseable_quickpay_welcart" id="chooseable_quickpay_welcart_1" value="on"<?php if( $acting_opts['chooseable_quickpay'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Member chooses', 'usces' ); ?></span></label><br />
					<label><input name="chooseable_quickpay" type="radio" class="chooseable_quickpay_welcart" id="chooseable_quickpay_welcart_0" value="off"<?php if( $acting_opts['chooseable_quickpay'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Always register', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_chooseable_quickpay_welcart" class="explanation card_chooseable_quickpay_welcart"><td colspan="2"><?php _e( "In case of 'Always register', 'Register and purchase credit card' will not be displayed when purchasing with credit card.", 'usces' ); ?></td></tr>
			<tr class="card_welcart">
				<th><a class="explanation-label" id="label_ex_operateid_welcart"><?php _e( 'Processing classification', 'usces' );//処理区分 ?></a></th>
				<td><label><input name="operateid" type="radio" id="operateid_welcart_1" value="1Auth"<?php if( $acting_opts['operateid'] == '1Auth' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Credit', 'usces' );//与信 ?></span></label><br />
					<label><input name="operateid" type="radio" id="operateid_welcart_2" value="1Gathering"<?php if( $acting_opts['operateid'] == '1Gathering' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Credit sales', 'usces' );//与信売上計上 ?></span></label>
				</td>
			</tr>
			<tr id="ex_operateid_welcart" class="explanation card_welcart"><td colspan="2"><?php _e( "In case of 'Credit' setting, it need to change to 'Sales recorded' manually in later. In case of 'Credit sales recorded' setting, sales will be recorded at the time of purchase.", 'usces' ); ?></td></tr>
			<?php if( defined( 'WCEX_DLSELLER' ) ): ?>
			<tr class="card_welcart">
				<th><a class="explanation-label" id="label_ex_operateid_dlseller_welcart"><?php _e( 'Automatic Continuing Charging Processing Classification', 'usces' );//自動継続課金処理区分 ?></a></th>
				<td><label><input name="operateid_dlseller" type="radio" id="operateid_dlseller_welcart_1" value="1Auth"<?php if( $acting_opts['operateid_dlseller'] == '1Auth' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Credit', 'usces' );//与信 ?></span></label><br />
					<label><input name="operateid_dlseller" type="radio" id="operateid_dlseller_welcart_2" value="1Gathering"<?php if( $acting_opts['operateid_dlseller'] == '1Gathering' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Credit sales', 'usces' );//与信売上計上 ?></span></label>
				</td>
			</tr>
			<tr id="ex_operateid_dlseller_welcart" class="explanation card_welcart"><td colspan="2"><?php _e( 'Processing classification when automatic continuing charging (required WCEX DLSeller).', 'usces' ); ?></td></tr>
			<tr class="card_welcart">
				<th><a class="explanation-label" id="label_ex_auto_settlement_mail_welcart"><?php _e( 'Automatic Continuing Charging Completion Mail', 'usces' );//自動継続課金完了メール ?></a></th>
				<td><label><input name="auto_settlement_mail" type="radio" id="auto_settlement_mail_welcart_1" value="on"<?php if( $acting_opts['auto_settlement_mail'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( "Send", 'usces' ); ?></span></label><br />
					<label><input name="auto_settlement_mail" type="radio" id="auto_settlement_mail_welcart_0" value="off"<?php if( $acting_opts['auto_settlement_mail'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( "Don't send", 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_auto_settlement_mail_welcart" class="explanation card_welcart"><td colspan="2"><?php _e( 'Send billing completion mail to the member on which automatic continuing charging processing (required WCEX DLSeller) is executed.', 'usces' ); ?></td></tr>
			<?php endif; ?>
			<tr class="card_howtopay_welcart">
				<th><a class="explanation-label" id="label_ex_howtopay_welcart"><?php _e( 'Number of payments', 'usces' );//支払回数 ?></a></th>
				<td><label><input name="howtopay" type="radio" id="howtopay_welcart_1" value="1"<?php if( $acting_opts['howtopay'] == '1' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Lump-sum payment only', 'usces' );//一括払いのみ ?></span></label><br />
					<label><input name="howtopay" type="radio" id="howtopay_welcart_2" value="2"<?php if( $acting_opts['howtopay'] == '2' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Activate installment payment', 'usces' );//分割払いを有効にする ?></span></label><br />
					<label><input name="howtopay" type="radio" id="howtopay_welcart_3" value="3"<?php if( $acting_opts['howtopay'] == '3' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Activate installment payments and bonus payments', 'usces' );//分割払いとボーナス払いを有効にする ?></span></label>
				</td>
			</tr>
			<tr id="ex_howtopay_welcart" class="explanation card_howtopay_welcart"><td colspan="2"><?php _e( 'It can be selected when using in non-passage type.', 'usces' ); ?></td></tr>
		</table>
		<table class="settle_table">
			<tr>
				<th><?php _e( 'Online storage agency', 'usces' );//オンライン収納代行 ?></th>
				<td><label><input name="conv_activate" type="radio" class="conv_activate_welcart" id="conv_activate_welcart_1" value="on"<?php if( $acting_opts['conv_activate'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="conv_activate" type="radio" class="conv_activate_welcart" id="conv_activate_welcart_0" value="off"<?php if( $acting_opts['conv_activate'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr class="conv_welcart">
				<th><?php _e( 'Payment due days', 'usces' );//支払期限日数 ?></th>
				<td><input name="conv_limit" type="text" id="conv_limit" value="<?php echo $acting_opts['conv_limit']; ?>" class="small-text" /><?php _e( 'days', 'usces' ); ?></td>
			</tr>
			<tr class="conv_welcart">
				<th><a class="explanation-label" id="label_ex_conv_fee_welcart"><?php _e( 'Fee', 'usces' );//手数料 ?></a></th>
			...
			<tr id="ex_conv_fee_welcart" class="explanation conv_welcart"><td colspan="2"><?php _e( 'Set the online storage agency commission and settlement upper limit. Leave it blank if you do not need it.', 'usces' ); ?></td></tr>
		</table>
		<table class="settle_table">
			<tr>
				<th><?php _e( 'Postpay settlement (ATODENE)', 'usces' );//後払い決済 ?></th>
				<td><label><input name="atodene_activate" type="radio" class="atodene_activate_welcart" id="atodene_activate_welcart_1" value="on"<?php if( $acting_opts['atodene_activate'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="atodene_activate" type="radio" class="atodene_activate_welcart" id="atodene_activate_welcart_0" value="off"<?php if( $acting_opts['atodene_activate'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr class="atodene_welcart">
				<th><a class="explanation-label" id="label_ex_atodene_byitem_welcart"><?php _e( 'Possibility of each items', 'usces' );//商品ごとの可否 ?></a></th>
				<td><label><input name="atodene_byitem" type="radio" id="atodene_byitem_welcart_1" value="on"<?php if( $acting_opts['atodene_byitem'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( "Enabled", 'usces' ); ?></span></label><br />
					<label><input name="atodene_byitem" type="radio" id="atodene_byitem_welcart_0" value="off"<?php if( $acting_opts['atodene_byitem'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( "Disabled", 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr id="ex_atodene_byitem_welcart" class="explanation atodene_welcart"><td colspan="2"><?php _e( 'It is effective when setting possibility of each items. Invalid when not distinguished in particular.<br />If enabled, a selection field will be added to determine whether postpay settlement is possible on the product registration screen. If there is a product in the cart that can not be postpaid settlement, we exclude postpaid settlement from the payment method options.<br />In addition, availability data is added to the product CSV as a custom field (welcartpay_atodene).', 'usces' ); ?></td></tr>
			<tr class="atodene_welcart">
				<th><a class="explanation-label" id="label_ex_atodene_billing_method_welcart"><?php _e( 'Invoice delivery method', 'usces' );//請求書送付方法 ?></a></th>
				<td><label><input name="atodene_billing_method" type="radio" id="atodene_billing_method_welcart_2" value="2"<?php if( $acting_opts['atodene_billing_method'] == '2' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Separate shipment', 'usces' );//別送 ?></span></label><br />
					<label><input name="atodene_billing_method" type="radio" id="atodene_billing_method_welcart_3" value="3"<?php if( $acting_opts['atodene_billing_method'] == '3' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Include shipment', 'usces' );//同梱 ?></span></label>
				</td>
			</tr>
			<tr id="ex_atodene_billing_method_welcart" class="explanation atodene_welcart"><td colspan="2"><?php _e( 'How to send invoices from ATODENE.', 'usces' ); ?></td></tr>
			<tr class="atodene_welcart">
				<th><a class="explanation-label" id="label_ex_atodene_fee_welcart"><?php _e( 'Fee', 'usces' ); ?></a></th>
				<td><span id="atodene_fee_type_field" class="fee_type_field"><?php echo $this->get_fee_name( $acting_opts['atodene_fee_type'] ); ?></span><input type="button" class="button" value="<?php _e( 'Detailed setting', 'usces' ); ?>" id="atodene_fee_setting" /></td>
			</tr>
			<tr id="ex_atodene_fee_welcart" class="explanation atodene_welcart"><td colspan="2"><?php _e( 'Set up postpaid settlement fee and maximum settlement amount. Leave it blank if you do not need it.', 'usces' ); ?></td></tr>
		</table>
		<table class="settle_table">
			<tr>
				<th><?php _e( 'UnionPay', 'usces' );//銀聯 ?></th>
				<td><label><input name="unionpay_activate" type="radio" class="unionpay_activate_welcart" id="unionpay_activate_welcart_1" value="on"<?php if( $acting_opts['unionpay_activate'] == 'on' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
					<label><input name="unionpay_activate" type="radio" class="unionpay_activate_welcart" id="unionpay_activate_welcart_0" value="off"<?php if( $acting_opts['unionpay_activate'] == 'off' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Do not Use', 'usces' ); ?></span></label>
				</td>
			</tr>
			<tr class="unionpay_welcart">
				<th><a class="explanation-label" id="label_ex_unionpay_key_aes_welcart"><?php _e( 'Tripartite Encryption Key', 'usces' );//銀聯三者間暗号化キー ?></a></th>
				<td><input name="unionpay_key_aes" type="text" id="unionpay_key_aes_welcart" value="<?php echo $acting_opts['unionpay_key_aes']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_unionpay_key_aes_welcart" class="explanation unionpay_welcart"><td colspan="2"><?php _e( 'UnionPay tripartite encryption key (single-byte alphanumeric characters only) issued by e-SCOTT.', 'usces' ); ?></td></tr>
			<tr class="unionpay_welcart">
				<th><a class="explanation-label" id="label_ex_unionpay_key_iv_welcart"><?php _e( 'Tripartite Initialization Vector', 'usces' );//銀聯三者間初期化ベクトル ?></a></th>
				<td><input name="unionpay_key_iv" type="text" id="unionpay_key_iv_welcart" value="<?php echo $acting_opts['unionpay_key_iv']; ?>" class="regular-text" /></td>
			</tr>
			<tr id="ex_unionpay_key_iv_welcart" class="explanation unionpay_welcart"><td colspan="2"><?php _e( 'UnionPay tripartite initialization vector (single-byte alphanumeric characters only) issued by e-SCOTT.', 'usces' ); ?></td></tr>
			<tr class="unionpay_welcart">
				<th><a class="explanation-label" id="label_ex_unionpay_pagelanguage_welcart"><?php _e( 'Page Language', 'usces' );//三者間ページ言語 ?></a></th>
				<td><select name="unionpay_pagelanguage" id="unionpay_pagelanguage_welcart">
						<option value=""><?php _e( 'Not set', 'usces' ); ?></option>
						<option value="zh_CN"<?php if( $acting_opts['unionpay_pagelanguage'] == 'zh_CN' ) echo ' selected="selected"'; ?>><?php _e( 'Chinese (Simplified)', 'usces' ); ?></option>
						<option value="zh_TW"<?php if( $acting_opts['unionpay_pagelanguage'] == 'zh_TW' ) echo ' selected="selected"'; ?>><?php _e( 'Chinese (Traditional)', 'usces' ); ?></option>
						<option value="en_US"<?php if( $acting_opts['unionpay_pagelanguage'] == 'en_US' ) echo ' selected="selected"'; ?>><?php _e( 'English', 'usces' ); ?></option>
						<option value="ja_JP"<?php if( $acting_opts['unionpay_pagelanguage'] == 'ja_JP' ) echo ' selected="selected"'; ?>><?php _e( 'Japanese', 'usces' ); ?></option>
						<option value="ko_KR"<?php if( $acting_opts['unionpay_pagelanguage'] == 'ko_KR' ) echo ' selected="selected"'; ?>><?php _e( 'Korean', 'usces' ); ?></option>
					</select>
				</td>
			</tr>
			<tr id="ex_unionpay_pagelanguage_welcart" class="explanation unionpay_welcart"><td colspan="2"><?php _e( 'Specifies the language of the SecurePay payment page. If not set, the page is displayed according to the language of the end user\'s browser. For mobile devices, only Chinese and English are displayed.', 'usces' ); ?></td></tr>
		</table>
	...
	<div class="settle_exp">
		...
		<p>&nbsp;</p>
		<p><?php echo __( "'Non-passage type' is a settlement system that completes with shop site only, without transitioning to the page of the settlement company.", 'usces' ); ?><br />
...
<?php
	...
	/**
	 * @fook   wcad_filter_admin_notices
	 * @param  $msg
	 * @return str $msg
	 */
	...
	public function acting_transaction() {
		...
		if( isset( $_REQUEST['MerchantFree1'] ) && isset( $_REQUEST['MerchantId'] ) && isset( $_REQUEST['TransactionId'] ) && isset( $_REQUEST['RecvNum'] ) && isset( $_REQUEST['NyukinDate'] ) && 
			...
			//銀聯決済
			if( isset( $_REQUEST['acting'] ) && $this->acting_unionpay == $_REQUEST['acting'] && $this->is_validity_acting( 'unionpay' ) ) {
					...
					if( isset( $response_data['OperateId'] ) && isset( $response_data['ResponseCd'] ) && isset( $response_data['MerchantFree1'] ) && 
						...
						if( 'OK' == $response_data['ResponseCd'] ) {
							...
							if( !empty( $order_data ) ) {
								...
								$log = array( 'acting'=>$this->acting_unionpay, 'key'=>$response_data['MerchantFree1'], 'result'=>'ORDER DATA REGISTERED ERROR', 'data'=>$response_data );
								usces_save_order_acting_error( $log );
								wp_redirect( add_query_arg( array( 'acting'=>$this->acting_unionpay, 'acting_return'=>0, 'result'=>0 ), USCES_CART_URL ) );
							}
			...
			//外部リンク（三者間画面）決済
				...
				$encryptvalue = openssl_decrypt( $_REQUEST['EncryptValue'], 'aes-128-cbc', $this->key_aes, false, $this->key_iv );
				if( $encryptvalue ) {
					parse_str( $encryptvalue, $response_data );
							...
							if( 'OK' == $response_data['ResponseCd'] ) {
								...
								if( '4MemAdd' == $response_data['OperateId'] || '4MemChg' == $response_data['OperateId'] ) {
									...
									if( isset( $response_data['EncodeXId3D'] ) ) {
										$param_list['EncodeXId3D'] = $response_data['EncodeXId3D'];
									}
									if( isset( $response_data['TransactionId3D'] ) ) {
										$param_list['TransactionId3D'] = $response_data['TransactionId3D'];
									}
									if( isset( $response_data['MessageVersionNo3D'] ) ) {
										$param_list['MessageVersionNo3D'] = $response_data['MessageVersionNo3D'];
									}
									if( isset( $response_data['TransactionStatus3D'] ) ) {
										$param_list['TransactionStatus3D'] = $response_data['TransactionStatus3D'];
									}
									if( isset( $response_data['CAVVAlgorithm3D'] ) ) {
										$param_list['CAVVAlgorithm3D'] = $response_data['CAVVAlgorithm3D'];
									}
									if( isset( $response_data['ECI3D'] ) ) {
										$param_list['ECI3D'] = $response_data['ECI3D'];
									}
									if( isset( $response_data['CAVV3D'] ) ) {
										$param_list['CAVV3D'] = $response_data['CAVV3D'];
									}
									if( isset( $response_data['SecureResultCode'] ) ) {
										$param_list['SecureResultCode'] = $response_data['SecureResultCode'];
									}
									...
									if( 'OK' == $response_data['ResponseCd'] ) {
										$res = $usces->order_processing( $response_data );
										if( 'ordercompletion' == $res ) {
											wp_redirect( add_query_arg( array( 'acting'=>$this->acting_card, 'acting_return'=>1, 'result'=>1, 'nonce'=>wp_create_nonce( 'welcart_transaction' ) ), USCES_CART_URL ) );
										} else {
											$logdata = array_merge( $usces_entries['order'], $response_data );
											$log = array( 'acting'=>$this->acting_card, 'key'=>$rand, 'result'=>'ORDER DATA REGISTERED ERROR', 'data'=>$logdata );
											usces_save_order_acting_error( $log );
											wp_redirect( add_query_arg( array( 'acting'=>$this->acting_card, 'acting_return'=>0, 'result'=>0 ), USCES_CART_URL ) );
										}
									} else {
										...
										$log = array( 'acting'=>$this->acting_card, 'key'=>$rand, 'result'=>$response_data['ResponseCd'], 'data'=>$logdata );
										usces_save_order_acting_error( $log );
										wp_redirect( add_query_arg( array( 'acting'=>$this->acting_card, 'acting_return'=>0, 'result'=>0 ), USCES_CART_URL ) );
									}
								...
								//決済
									...
									if( 'ordercompletion' == $res ) {
										...
										$log = array( 'acting'=>$this->acting_card, 'key'=>$response_data['MerchantFree1'], 'result'=>'ORDER DATA REGISTERED ERROR', 'data'=>$response_data );
										usces_save_order_acting_error( $log );
										wp_redirect( add_query_arg( array( 'acting'=>$this->acting_card, 'acting_return'=>0, 'result'=>0 ), USCES_CART_URL ) );
									}
								}
								...
								wp_redirect( add_query_arg( array( 'acting'=>$this->acting_card, 'confirm'=>1 ), USCES_CART_URL ) );
		...
		case 'continuation_update':
			...
			if( $continue_data['status'] == 'continuation' && $status == 'cancellation' ) {
				...
				if( $new_charged_date < $tomorrow ) {
					$data['status'] = 'NG';
					//$data['message'] = sprintf( __( "The next settlement date must be after %s.", 'dlseller' ), $charged_date );
	...
	/**
	 * 決済状況
	 * @fook   usces_filter_orderlist_detail_value
	...
	/**
	 * 受注編集画面【ステータス】
	 * @fook   usces_action_order_edit_form_status_block_middle
	...
	/**
	 * 受注編集画面【支払情報】
	 * @fook   usces_action_order_edit_form_settle_info
...
/*			if( usces_is_login() && 'on' == $acting_opts['quickpay'] && empty( $quick_member ) ) {
				...
				if( !empty( $member['ID'] ) && 'on' == $acting_opts['quickpay'] && ( 'add' == $quick_member || 'update' == $quick_member ) ) {
					...
					$encryptvalue = openssl_encrypt( $data_query, 'aes-128-cbc', $this->key_aes, false, $this->key_iv );
...
/*			}*/
	...
	/**
	 * @fook   usces_fiter_the_payment_method_explanation
	...
	/**
	 * @fook   usces_filter_delivery_secure_form_howpay
	 * @param  $html
	 * @return string $html
	 */
...
<?php
	...
	public function message_continue_order( $member_id ) {
		...
		$query = $wpdb->prepare( "SELECT * FROM {$continuation_table} WHERE `con_member_id` = %d AND `con_acting` = %s AND `con_status` = 'continuation'", $member_id, 'acting_welcart_card' );
	...
	public function message_regular_order( $member_id ) {
		...
		$query = $wpdb->prepare( "SELECT r.reg_id, r.reg_payment_name, d.regdet_schedule_date FROM {$regular_detail_table_name} AS `d` INNER JOIN {$regular_table_name} AS `r` WHERE r.reg_mem_id = %d AND d.regdet_condition = 'continuation' GROUP BY r.reg_id", $member_id );
	...
	/**
	 * @fook   usces_filter_the_continue_payment_method
	...
	/**
	 * @fook   dlseller_filter_the_payment_method_restriction wcad_filter_the_payment_method_restriction
	...
	/**
	 * 「初回引落し日」
	 * @fook   dlseller_filter_first_charging
	...
	/**
	 * 継続課金会員リスト「有効期限」
	 * @fook   dlseller_filter_continue_member_list_limitofcard
	 * @param  $limitofcard $member_id $order_id $meta_data
	 * @return string $limitofcard
	 */
	...
	/**
	 * 継続課金会員リスト「契約」
	 * @fook   dlseller_filter_continue_member_list_continue_status
	...
	/**
	 * 継続課金会員リスト「状態」
	 * @fook   dlseller_filter_continue_member_list_condition
	...
	/**
	 * 継続課金会員決済状況ページ表示
	 * @fook   dlseller_action_continue_member_list_page
...
?>
	...
	<tr>
		...
		<td><span id="settlement-status-<?php echo $num; ?>"><span class="acting-status<?php echo $class; ?>"><?php echo $status_name; ?></span></span></td>
		<td>
...
?>
	...
	<tr>
		...
		<td class="amount"><?php echo $Amount; ?></td>
		<?php if( !empty( $status_name ) ): ?>
		<td><span id="settlement-status-1"><span class="acting-status<?php echo $class; ?>"><?php echo $status_name; ?></span></span></td>
...
<?php
	 ...
	 * @fook   dlseller_filter_card_update_mail
	...
	/**
	 * 自動継続課金処理
	 * @fook   dlseller_action_do_continuation_charging
		...
		if( !empty( $KaiinId ) && !empty( $KaiinPass ) ) {
			...
			if( 'OK' == $response_member['ResponseCd'] ) {
				...
				if( 'OK' == $response_data['ResponseCd'] ) {
					...
					$log = array( 'acting'=>$this->acting_card, 'key'=>$rand, 'result'=>$response_data['ResponseCd'], 'data'=>$response_data );
					usces_save_order_acting_error( $log );
					$this->save_acting_log( $response_data, $order_id.'_'.$rand );
				...
				$log = array( 'acting'=>$this->acting_card.'(member_process)', 'key'=>$member_id, 'result'=>$response_member['ResponseCd'], 'data'=>$response_member );
				usces_save_order_acting_error( $log );
			...
			$log = array( 'acting'=>$this->acting_card.'(member_process)', 'key'=>$member_id, 'result'=>'MEMBER ERROR', 'data'=>$logdata );
			usces_save_order_acting_error( $log );
			$log['ResponseCd'] = 'NG';
	...
	/**
	 * 自動継続課金処理
	 * @fook   dlseller_action_do_continuation
	...
	/**
	 * 課金日通知メール
	 * @fook   dlseller_filter_reminder_mail_body
	 * @param  $mail_body $order_id $continue_data
	 * @return -
	 */
	...
	/**
	 * 契約更新日通知メール
	 * @fook   dlseller_filter_contract_renewal_mail_body
	 * @param  $mail_body $order_id $continue_data
	 * @return -
	 */
	...
	/**
	 * @fook   wcad_filter_available_regular_payment_method
	 * @param  $payment_method
	 * @return array $payment_method
	 */
	...
	/**
	 * @fook   wcad_filter_shippinglist_acting
	 * @param  $acting
	...
	/**
	 * 定期購入決済処理
	 * @fook   wcad_action_reg_auto_orderdata
	 * @param  $args = array(
	...
	public function get_acting_latest_log( $log_key, $responsecd = 'OK' ) {
		...
		$latest_log = array();
		$latest_status = array( '1Auth', '1Capture', '1Gathering', '1Delete', '2Add', '2Chg', '2Del', '5Auth', '5Gathering', '5Capture', '5Delete', 'receipted', '11Gathering', '11Delete' );
	 ...
	 * @fook   usces_action_order_list_page
	 * @param  $order_action
	 * @return -
	 */
	...
	/**
	 * ATODENE アクションボタン
	 * @fook   usces_action_order_list_searchbox_bottom
	 * @param  -
	 * @return -
	 */
	public function action_atodene_button() {
?>
				<input type="button" id="dl_atodene_register_csv" class="searchbutton button" value="<?php _e( 'ATODENE transaction registration CSV output', 'usces' ); ?>" />
				...
				<input type="button" id="up_atodene_results_csv" class="searchbutton button" value="<?php _e( 'ATODENE credit review result CSV upload', 'usces' ); ?>" />
				<input type="button" id="dl_atodene_report_csv" class="searchbutton button" value="<?php _e( 'ATODENE shipping report registration CSV output', 'usces' ); ?>" />
<?php
	}

	/**
	 * ATODENE CSVアップロードダイアログ
	 * @fook   usces_action_order_list_footer
	 * @param  -
	 * @return -
	 */
	 ...
	 * @fook   usces_filter_order_list_page_js
	 * @param  -
	 * @return -
	 */
...
*/
	...
	/**
	 * ATODENE アクションステータス
	 * @fook   usces_order_list_action_status
	 * @param  -
	 * @return -
	 */
	 ...
	 * @fook   usces_order_list_action_message
	 * @param  -
	 * @return -
	 */
	...
	/**
	 * ATODENE 運送会社名
	 * @fook   usces_filter_deli_comps
	 * @param  -
	 * @return -
	 */
	public function delivery_company_name( $deli_comps ) {
		$deli_comps = array( '佐川急便', 'ヤマト運輸', 'クロネコメール便', 'ゆうパック', 'レターパック', '福山通運', '西濃運輸' );
	...
	/**
	 * 後払い決済の可否
	 * @fook   usces_item_master_second_section
	...
	/**
	 * 後払い決済の可否更新
	 * @fook   usces_action_save_product
	 * @param  $post_id $post
	 * @return -
	 */
	...
	/**
	 * @fook   usces_filter_nonacting_settlements
	...
	/**
	 * @fook   wcad_filter_the_payment_method_restriction
	 * @param  $payments_restriction $value
	 * @return array $payments_restriction
	 */
