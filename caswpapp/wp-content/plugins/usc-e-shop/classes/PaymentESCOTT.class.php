	...
	<form action="" method="post" name="escott_form" id="escott_form">
		<table class="settle_table">
			<tr>
				...
				<td><input name="merchant_id" type="text" id="merchant_id_escott" value="<?php echo $acting_opts['merchant_id']; ?>" class="regular-text" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="merchant_pass" type="text" id="merchant_pass_escott" value="<?php echo $acting_opts['merchant_pass']; ?>" class="regular-text" /></td>
			</tr>
			...
			<tr>
				...
				<td><input name="tenant_id" type="text" id="tenant_id_escott" value="<?php echo $acting_opts['tenant_id']; ?>" class="regular-text" /></td>
			</tr>
		...
		<table class="settle_table">
			<tr>
				...
				<td><label><input name="card_activate" type="radio" class="card_activate_escott" id="card_activate_escott_1" value="on"<?php if( $acting_opts['card_activate'] == 'on' || $acting_opts['card_activate'] == 'token' ) echo ' checked="checked"'; ?> /><span><?php _e( 'Use', 'usces' ); ?></span></label><br />
			...
			<tr class="card_escott">
				...
				<td><input name="token_code" type="text" id="token_code_escott" value="<?php echo $acting_opts['token_code']; ?>" class="regular-text" maxlength="32" /></td>
			</tr>
			<tr id="ex_token_code_escott" class="explanation card_escott"><td colspan="2"><?php _e( "Token auth code (single-byte alphanumeric characters only) issued from e-SCOTT.", 'usces' ); ?></td></tr>
			<tr class="card_escott">
