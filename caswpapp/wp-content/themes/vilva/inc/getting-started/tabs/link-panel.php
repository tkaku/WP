...
<div class="panel-right">
	<div class="panel-aside">
		...
		<a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/downloads/vilva-pro/' ); ?>" title="<?php esc_attr_e( 'View Premium Version', 'vilva' ); ?>" target="_blank">
	...
	<div class="panel-aside">
		...
		<a class="button button-primary" href="<?php echo esc_url( 'https://docs.blossomthemes.com/docs/vilva/' ); ?>" title="<?php esc_attr_e( 'Visit the knowledge base', 'vilva' ); ?>" target="_blank"><?php esc_html_e( 'Visit the Knowledge Base', 'vilva' ); ?></a>
