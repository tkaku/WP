...
function vilva_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'vilva' ),  '<a href="' . esc_url( 'https://docs.blossomthemes.com/docs/vilva/' ) . '" target="_blank">', '</a>' ); 
    $theme_info .= '</p>';
	...
	$manager->add_section(
		new Vilva_Customize_Section_Pro(
			...
			array(
				...
				'pro_url'  => esc_url( 'https://blossomthemes.com/downloads/vilva-pro/' ), 
			)
		)
	);
}
